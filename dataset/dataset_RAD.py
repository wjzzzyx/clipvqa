...
class VQARADFeatureDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        if None!=answer:
            ...
            return  image_data,question_data, composed_target, answer_type, question_type, phrase_type, answer_target, entry['image_name'], entry['question'], str(entry['answer_text'])
        
        else:
            return image_data, question_data, answer_type, question_type, phrase_type, answer_target, entry['image_name'], entry['question'], str(entry['answer_text'])
