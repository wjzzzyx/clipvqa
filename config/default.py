...
_C.TRAIN.QUESTION.PREFIX_LEN = 10
_C.TRAIN.QUESTION.COND_PROMPT = False
_C.TRAIN.QUESTION.EMBED_TYPE = ""
# 
# 
# # ----- VISION -----
_C.TRAIN.VISION = CN()
...
_C.TRAIN.VISION.PREFIX_LEN = 10
_C.TRAIN.VISION.COND_PROMPT = False
_C.TRAIN.VISION.HID_DIM = 512
_C.TRAIN.VISION.POOL_DIM = 0
_C.TRAIN.VISION.EMBED_TYPE = ""
# 
# # ------ Answer ------
_C.TRAIN.ANSWER = CN()
...
# 
# # ------ Multimodal ------
_C.TRAIN.MULTIMODAL = CN()
_C.TRAIN.MULTIMODAL.WIDTH = 512
_C.TRAIN.MULTIMODAL.LAYERS = 12
_C.TRAIN.MULTIMODAL.HEADS = 8
# 
# # ----- CLASSIFIER -----
...
# 
# _C.TRAIN.CLIP = False
# _C.TRAIN.CLIPV2 = False
# _C.TRAIN.CLIPV3 = False
_C.TRAIN.CLIP_TYPE = ""
# _C.TRAIN.CLIP_PATH = ""
_C.TRAIN.IMAGE_ENCODER_PATH = ""
_C.TRAIN.TEXT_ENCODER_PATH = ""
_C.TRAIN.TOKENIZER_PATH = ""
_C.TRAIN.QAS = ""
